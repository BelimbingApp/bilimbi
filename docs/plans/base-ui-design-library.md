...
The shell account menu, top-bar timezone/theme controls and the named icon vocabulary were the next slice's recorded requirements and shipped on 2026-09-15; `docs/plans/base-ui-design-parity.md` owns their delivery record, including the later searchable icon catalogue. The wider parity campaign, optional inspection skill and adopter-owned library are follow-up work and do not block this foundation's closeout.
