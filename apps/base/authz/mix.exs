...
defmodule Bilimbi.Base.Authz.MixProject do
  ...
  def application do
    module_env = Bilimbi.Base.ModuleRegistry.MixDiscovery.application_env(__DIR__)

    [
      extra_applications: [:logger],
      env: module_env ++ [bilimbi_production_seed_provider: Bilimbi.Base.Authz.ProductionSeeds]
    ]
  end
