...
defmodule Bilimbi.Base.Menu.MixProject do
  use Mix.Project
  ...
  # Menu owns no tables and performs no I/O; it needs no Ecto.
  defp deps, do: Bilimbi.Base.ModuleRegistry.MixDiscovery.module_dependencies(__DIR__)
end
