defmodule BilimbiWeb.EmployeeLive.Index do
  @moduledoc """
    ...
    <Layouts.app flash={@flash} current_scope={@current_scope} active_nav={@active_nav}>
      <div class="mx-auto max-w-4xl">
        <.header>
          ...
          <:actions>
            <.link
              :if={UserAuth.allowed?(@current_scope, "admin.employee-type.list")}
            ...
            <.button
              :if={UserAuth.allowed?(@current_scope, "admin.employee.create")}
              id="employee-new"
