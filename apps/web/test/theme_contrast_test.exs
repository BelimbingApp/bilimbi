defmodule BilimbiWeb.ThemeContrastTest do
  ...
  #
  # `ink-subtle` carries table headers and other 12px semibold body text, so it
  # is gated as body text too (parity finding C2). `ink-muted` is the role the
  # decision-log acting-for line moved onto (finding C3).
  @pairs [
    {"ink", "surface", 4.5},
    {"ink", "canvas", 4.5},
