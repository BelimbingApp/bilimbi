defmodule BilimbiWeb.ThemeContrastTest do
  ...
  @tailwind %{
    ...
    "var(--color-blue-200)" => "#bedbff",
    "var(--color-blue-500)" => "#2b7fff",
    "var(--color-blue-600)" => "#155dfc",
    "var(--color-blue-800)" => "#193cb8",
    "var(--color-blue-900)" => "#1c398e",
    "var(--color-blue-950)" => "#162456",
