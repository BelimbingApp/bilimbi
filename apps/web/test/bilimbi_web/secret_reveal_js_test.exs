defmodule BilimbiWeb.SecretRevealJsTest do
  @moduledoc """
  Pins the LiveView internals the reveal control relies on, in the shipped
  bundle. The hook's own behaviour is tested with the other hooks in
  `apps/web/assets/test/secret_reveal.test.mjs`.
  """
