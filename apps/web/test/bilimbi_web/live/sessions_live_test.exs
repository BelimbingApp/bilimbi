defmodule BilimbiWeb.SessionsLiveTest do
  ...
  # The ruling on #285 is a hybrid: names inside the actor's tenant, ids
  # outside it. This is the half that keeps the tenant boundary -- a plain
  # join would name every row and leak across it.
