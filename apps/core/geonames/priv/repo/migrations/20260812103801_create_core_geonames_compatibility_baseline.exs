defmodule Bilimbi.Core.Geonames.Migrations.CreateCompatibilityBaseline do
  ...
  def up do
    ...
    create(
      unique_index(:geonames_countries, [:iso_numeric],
    ...
    create(
      unique_index(:geonames_countries, [:geoname_id],
    ...
    create(
      unique_index(:geonames_admin1, [:geoname_id], name: :geonames_admin1_geoname_id_unique)
    )
    ...
    create(
      index(:geonames_postcodes, [:country_iso], name: :geonames_postcodes_country_iso_index)
    )
    ...
    create(
      index(:geonames_postcodes, [:country_iso, :postcode],
        name: :geonames_postcodes_country_iso_postcode_index
      )
    )

    create(
      index(:geonames_postcodes, [:country_iso, :place_name],
    ...
    create(
      unique_index(:geonames_cities, [:geoname_id], name: :geonames_cities_geoname_id_unique)
    )
