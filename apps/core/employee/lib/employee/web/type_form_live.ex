defmodule Bilimbi.Core.Employee.Web.TypeFormLive do
  ...
  System type codes are reserved; a custom type belongs to the company and
  its code is immutable after creation. Changing a type's label happens on
  its record page, `Bilimbi.Core.Employee.Web.TypeShowLive`, in place.
  """
