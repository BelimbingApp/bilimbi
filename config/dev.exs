...
config :bilimbi, BilimbiWeb.Endpoint,
  ...
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:bilimbi, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:bilimbi, ~w(--watch)]}
  ]
...
config :bilimbi, dev_routes: true
